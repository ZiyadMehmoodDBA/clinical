<%@ Page  Title="Home Page"  Async="true" Language="C#" AutoEventWireup="True" CodeBehind="MDVisioniTrack.aspx.cs" Inherits="MDVision.IEHR.MDVisioniTrack" %>
...
<head id="PageHead" runat="server">
    ...
    <asp:PlaceHolder ID="PlaceHolder2" runat="server">
        ...
        <%:Scripts.Render("~/bundles/iTrackFiles") %>
...
<body onload="initSession();">
                            ...
                            <div class="tabs">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li id="mstrTabiTrack" runat="server" visible="false">
                                        <a href="#iTrack" data-toggle="tooltip" title="iTrack" onclick="SelectTab('mstrTabiTrack','false');">
                                            <span>iTrack</span>
                                            <i class="fa fa-book"></i>
                                        </a>
                                    </li>
                                ...
                                <nav id="menu" class="nav-main" role="navigation">
                                    <ul class="nav nav-main" id="mainUL">
                                        ...
                                        <li id="mstrMenuReports" runat="server" class="nav-parent" visible="false">
                                            <a class="nav-parent noContentAfter" runat="server" href="MDVisionDefault.aspx#Reports">
    ...
    <%: Scripts.Render("~/bundles/StartupiTrack") %>
