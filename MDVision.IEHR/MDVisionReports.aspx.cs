...
{
    public partial class _MDVisionReports : System.Web.UI.Page
    {
        /// <summary>
        ...
        protected void Page_PreInit(object sender, EventArgs e)
        {
            ...
            if (error != "")
            {
                MDVLogger.PresentationLog("mdvisionDefault.aspx", "Page_PreInit", error, "AliAwan", "none");
                new BLLAdminSecurity().InsertUsersActivityLog(DALUsersActivity.AuditableEvents.LogIn, DALUsersActivity.TITLE_SOFTWARE_NAME, false, "Error during Login user: " + error);
                Response.Redirect(MDVSession.Current.WebEntityURL + "MDVisionLogin.aspx?error=" + error, false);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (IsPostBack == false)
            {
                ...
                try
                {
                    ...
                    {
                        Response.Redirect(MDVSession.Current.WebEntityURL + "MDVisionLogin.aspx", false);
