...
namespace MDVision.IEHR.EMR.Model.Patient
{
    public class PatientReferralModel
    {
        ...
        public string Visits_text { get; set; }
        ...
        public List<PatientReferralProblemListModel> ReferralProblemList { get; set; }
        public List<PatientReferralProcedureModel> ReferralProcedure { get; set; }
        ...
        public string IsFromDashBoard { get; set; }
        public string StatusReasonsIds { get; set; }
    }
}