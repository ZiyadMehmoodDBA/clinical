 ...
 * Created to define properties of Characteristic Detail against a characteristic in PatientPhysicalExam          
 */
using System;
...
{
    public class PatientPhysicalExamCharacteristicDetailModel
    {
