...
namespace MDVision.IEHR.EMR.Model.Clinical
{
    ...
    public class CCDACaseReportDataModel
    {
        public CCDACaseReportDataModel
            (
              string VisitDate,
              ...
              List<Dictionary<string, string>> lstSocialOccupations,
              List<Dictionary<string, string>> lstSocialTravels,
              List<Dictionary<string, string>> lstSocialSexuals,
              ...
              List<Dictionary<string, string>> lstEncounterDiagnosicNonTriggerDatakeyValues,
              ...
              List<Dictionary<string, string>> lstComplaints
            ...
            )
        {
            ...
            this.lstSocialOccupations = lstSocialOccupations;
            this.lstSocialTravels = lstSocialTravels;
            this.lstSocialSexuals = lstSocialSexuals;
            ...
            this.lstEncounterDiagnosicNonTriggerDatakeyValues = lstEncounterDiagnosicNonTriggerDatakeyValues;
        ...
        public List<Dictionary<string, string>> lstSocialOccupations { get; set; }
        public List<Dictionary<string, string>> lstSocialTravels { get; set; }
        public List<Dictionary<string, string>> lstSocialSexuals { get; set; }
        ...
        public List<Dictionary<string, string>> lstHPI { get; set; }
        ...
        public List<Dictionary<string, string>> lstEncounterDiagnosicNonTriggerDatakeyValues { get; set; }
        ...
        public List<Dictionary<string, string>> lstComplaints { get; set; }

    }


    public class ComponentCaseReport
    {
    ...
    public class componentNameCaseReport
    {
