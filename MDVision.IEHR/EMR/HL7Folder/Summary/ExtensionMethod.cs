...
namespace MDVision.IEHR.EMR.HL7Folder.Summary
{
    public static class ExtensionMethod
    {
        ...
        public static String ToFormatedString(this object obj, string format = "", CCDAReconcile.TextFormateType textFormateType = CCDAReconcile.TextFormateType.Normal)
        {
            ...
            if (!string.IsNullOrEmpty(returnValue))
            {
                ...
                if (textFormateType != CCDAReconcile.TextFormateType.Normal)
                {
                    switch (textFormateType)
                    {
                        case CCDAReconcile.TextFormateType.Upper:
                            returnValue = returnValue.ToUpper();
                            break;
                        case CCDAReconcile.TextFormateType.Lower:
                            returnValue = returnValue.ToLower();
                            break;
                        case CCDAReconcile.TextFormateType.Title:
        ...
        public static bool Validate(this ClinicalDocument document, string templateId)
        {
            bool validCcda = false;
            if (!String.IsNullOrWhiteSpace(templateId) && document.HasComponents())
            {
                List<II> templates = document.templateId;
        ...
        public static PatientRole GetPatientRole(this ClinicalDocument document)
        {
            PatientRole pr = null;
        ...
        public static IntendedRecipient GetIntendedRecipient(this ClinicalDocument document)
        {
            IntendedRecipient ir = null;
            if (document != null && !document.informationRecipient.IsNullOrEmpty() && document.informationRecipient[0].intendedRecipient != null)
            {
                ir = document.informationRecipient[0].intendedRecipient;
            }
            return ir;
        }

        public static AssignedAuthor GetAuthor(this ClinicalDocument document)
        {
            AssignedAuthor author = null;
            if (document != null && !document.author.IsNullOrEmpty() && document.author.Count() > 0 && document.author[0].assignedAuthor != null)
            {
                author = document.author[0].assignedAuthor;
            }
            return author;
        }

        public static Patient GetPatient(this ClinicalDocument document)
        {
            Patient p = null;
        ...
        public static string GetConfidentialityCode(this ClinicalDocument document)
        {
            string Confidentialitycode = "";
            if (document != null && !document.confidentialityCode.code.IsNull())
            {
                Confidentialitycode = document.confidentialityCode.code;
            }

            return Confidentialitycode;
        }
        public static bool HasComponents(this ClinicalDocument document)
        {
        ...
        public static List<Component3> GetComponents(this ClinicalDocument document)
        {
        ...
        public static bool GetComponentByTemplateId(this ClinicalDocument document, ref Component3 component, string templateId)
        {
        ...
        public static bool GetComponentByTemplateIDs(this ClinicalDocument document, ref Component3 component, List<String> templateIDs)
        {
            bool isComponentExist = false;
        ...
        public static bool GetComponents(this ClinicalDocument document, ref List<Component3> componentList)
        {
            bool isExist = false;
