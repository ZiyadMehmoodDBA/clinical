<%@ Page Title="Home Page" Async="true" Language="C#" AutoEventWireup="true" CodeBehind="MDVisionAuditableEvents.aspx.cs" Inherits="MDVision.IEHR._AuditableEvents" %>
...
<head id="PageHead" runat="server">
    ...
    <asp:PlaceHolder ID="PlaceHolder2" runat="server">
        ...
        <%:Scripts.Render("~/bundles/AuditableEventFiles") %>
                              ...
                              <ul class="nav nav-tabs">
                                  ...
                                  <li id="mstrTabiTrack" runat="server" visible="false">
                                    ...
                                    <li id="mstrTabAuditbleEvents" runat="server" visible="false">
                                        <a href="#AuditableEvents" data-toggle="tooltip" title="Auditable Events" onclick="SelectTab('mstrTabAuditbleEvents','false');">
                                ...
                                <nav id="menu" class="nav-main" role="navigation">
                                     <ul class="nav nav-main" id="mainUL">
                                        ...
                                        <li class="nav-parent" id="mstrMenuAuditbleEvents" runat="server" visible="false">
                                            <a class="noContentAfter" href="MDVisionAuditableEvents.aspx#AuditableEvents" title="Auditable Events">
...
<%: Scripts.Render("~/bundles/AuditableEventsStartup") %>