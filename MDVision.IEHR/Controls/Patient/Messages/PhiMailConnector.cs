 ...
 * 
 * This class provides a sample implementation of the phiMail Server Integration API 
 * calls to allow client software to send and receive messages and to receive status 
 * information.
 * 
 ...
 * License Agreement ("DLA"). Additionally, you may modify this code 
 * for your own use, as you see fit.
 * 
 */
...
namespace MDVision.IEHR.Controls.Patient.Messages
{
    ...
    public class PhiMailConnector : IDisposable
    {
        ...
        public static void SetTrustAnchor(X509Certificate anchorCert)
        {
            SetServerCertificate(anchorCert);
        }

        /// <summary>
        /// Set a trusted phiMail Server SSL anchor using the filename pointing to the anchor's certificate
        /// file. This trust anchor will be allowed even if it is not in the system's trusted certificate store.
        /// </summary>
