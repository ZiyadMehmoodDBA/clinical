...
namespace MDVision.IEHR.Controls.Batch.CQM
{
    public class CatagoryOneXMLGenerator : CatagoryOneXMLDataExtraction
    {
        ...
        private static DSCQM GetMeasureSection_CategoryOne( Int64 providerId, string cqmid, string startDate, string endDate, bool isC1 = false)
        {
            var obj = new BLLCQM().Load_CQM(providerId, null, startDate, endDate, null, 0, cqmid,null,0,null,null,null,null,null,0,null,null,0,0,0, isC1);
        ...
        public static List<KeyValuePair<string, string>> InitializeCategoryOne_DataSets( string cqmid, Int64 patientId, Int64 providerId,
            Int64 practiceId, string startDate, string endDate, List<string> listPatients, bool isC1 = false)
        {
            #region Instantiate Record Set


            _dsPatientDemoGraphic = GetPatient_CategoryOne(cqmid, providerId, startDate, endDate,isC1);
            ...
            _dsMeasureSection = GetMeasureSection_CategoryOne(providerId, cqmid, startDate, endDate, isC1);
            ...
            for (var i = 0; i < listPatients.Count; i++)
            {
                ...
                var currentFileContent = GenerateCategoryOne_XML(cqmid, patientId, providerId, practiceId, startDate, endDate, _dsMeasureSection, isC1);
        ...
        private static string GenerateCategoryOne_XML( string cqmid, Int64 patientId, Int64 providerId, Int64 practiceId, string startDate, string endDate, DSCQM _dsMeasureSection, bool isC1 = false )
        {
            ...
            BuildTemplate(cqmid, patientId, providerId, practiceId, startDate, endDate, _dsMeasureSection, isC1);
            ...
            xml = xml.Replace("compression=\"DF\"", "").Replace("frame=\"void\" rules=\"none\"", "")
                ...
                .Replace("d10p1:valueSet", "sdtc:valueSet").Replace("xmlns:d10p1=\"urn:hl7-org:sdtc\" ", "").Replace("xmlns:d13p1=\"urn:hl7-org:sdtc\" ", "").Replace("xmlns:d8p1=\"urn:hl7-org:sdtc\" ", "");
            ...
            xml = xml.Replace("negationInd = \"false\"", "").Replace("negationInd=\"false\"", "").Replace(("negationInd = \"false\"").Trim(), string.Empty);
        ...
        private static void BuildTemplate( string cqmid, Int64 patientId, Int64 providerId, Int64 practiceId, string startDate, string endDate, DSCQM dsMeasureSection, bool isC1 = false)
        {
            ...
            catagoryOneXmlSectionLevelTemplates.BuildSectionLevelTemplate(_document, _dsPatientDemoGraphic, _dsProvider, _dsPractice, cqmid, patientId, providerId, practiceId, startDate, endDate, dsMeasureSection, isC1);
        }
    }
}