<%@ Page Title="Home Page" Async="true" Language="C#" AutoEventWireup="true" CodeBehind="MDVisionReports.aspx.cs" Inherits="MDVision.IEHR._MDVisionReports" %>
...
<head id="PageHead" runat="server">
    ...
    <asp:PlaceHolder ID="PlaceHolder2" runat="server">
        ...
        <%:Scripts.Render("~/bundles/ReportsFiles") %>
...
<body onload="initSession();">
            ...
            <div>
                ...
                <%--<svg width="80px" height="80px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="uil-ripple">
                    <rect x="0" y="0" width="100" height="100" fill="none" class="bk"></rect><g>
                        ...
                        <circle cx="50" cy="50" r="25.7579" stroke="#295596" fill="none" stroke-width="6" stroke-linecap="round">
                            <animate attributeName="r" dur="1.5s" repeatCount="indefinite" begin="-0.75s" keyTimes="0;0.33;1" values="0;22;44"></animate>
                        </circle>
                    </g><g><animate attributeName="opacity" dur="1.5s" repeatCount="indefinite" begin="0s" keyTimes="0;0.33;1" values="1;1;0"></animate>
                        <circle cx="50" cy="50" r="42.1758" stroke="#0f2ab5" fill="none" stroke-width="6" stroke-linecap="round">
        ...
        <section class="body">
            <header class="header">
                ...
                <section class="mainSec profile-small">
                    <section>
                        <div class="pprofile-adjust disableAll" >
                            ...
                            <div id="userbox" class="userbox">
                                ...
                                <div class="dropdown-menu">
                                    <ul class="list-unstyled">
                                        ...
                                        <li>
                                            <asp:Button ID="btnLogout" runat="server" Text="&#xf011; &nbsp;Logout" OnClientClick="localStorage.removeItem('SelectedPatientId')" OnClick="Logout_Click" />
                                        </li>
                            ...
                            <div class="tabs">
                              <ul class="nav nav-tabs">
                                    ...
                                    <li id="mstrTabReports" runat="server" visible="false">
                                        <a href="#Reports" data-toggle="tooltip" title="Reports" onclick="SelectTab('mstrTabReports','false');">
                                            <span>Reports</span>
                                  ...
                                  <li id="mstrTabiTrack" runat="server" visible="false">
                                         <a href="MDVisioniTrack.aspx#iTrack" data-toggle="tooltip" title="iTrack" onclick="CheckDemographicDetailOnRedirect('MDVisioniTrack.aspx#iTrack', event);">
                                            <span>iTrack</span>
                                            <i class="fa fa-book"></i>
                                        </a>
                                    </li>
                                    <li id="mstrTabAuditbleEvents" runat="server" visible="false">
                                        <a href="MDVisionAuditableEvents.aspx#AuditbleEvents" data-toggle="tooltip" title="Auditable Events">
                                            <span>Auditable Events</span>
                                            <i class="fa fa-calendar-check-o"></i>
                                        </a>
                                    </li>
                                    <li id="mstrTabAdmin" runat="server" visible="false">
                                        <a href="MDVisionAdmin.aspx#Admin" title="Admin">
                                            <span>Admin</span>
                                ...
                                <nav id="menu" class="nav-main" role="navigation">
                                     <ul class="nav nav-main" id="mainUL">
                                        ...
                                        <li id="mstrMenuPatient" class="nav-parent" runat="server" visible="false">
                                           ...
                                           <%-- <ul class="nav nav-children">
                                                <li runat="server" id="patMenuDemographic" class="nav-active" visible="false">
                                                    <a href="MDVisionDefault.aspx#Patient/patTabDemographic" action="patTabDemographic" title="Demographics">Demographics</a>
                                                </li>
                                                <li runat="server" id="patMenuInsurance" visible="false">
                                                    <a href="MDVisionDefault.aspx#Patient/patTabInsurance" action="patTabInsurance" title="Insurance">Insurance</a>
                                                </li>
                                                <li runat="server" id="patMenuDocuments" visible="false">
                                                    <a href="MDVisionDefault.aspx#Patient/patTabDocuments" action="patTabDocuments" title="Documents">Documents</a>
                                                </li>
                                                <li runat="server" id="patMenuMessages" visible="false">
                                                    <a href="MDVisionDefault.aspx#Patient/patTabMessages" action="patTabMessages" title="Tasks">Tasks</a>
                                                </li>
                                                <li runat="server" id="patMenuUserMessages" visible="false">
                                                    <a href="MDVisionDefault.aspx#Patient/patTabUserMessages" action="patTabUserMessages" title="Messages">Messages</a>
                                                </li>
                                                <li runat="server" id="patMenuCaseManagement" visible="false">
                                                    <a href="MDVisionDefault.aspx#Patient/patTabCaseManagement" action="patTabCaseManagement" title="Case Management">Case Management</a>
                                                </li>
                                                <li runat="server" id="patMenuActivityLog" visible="false">
                                                    <a href="MDVisionDefault.aspx#Patient/patTabActivityLog" action="patTabActivityLog" title="Audit Log">Audit Log</a>
                                                </li>
                                                <li runat="server" id="patMenuReferrals" visible="false">
                                                    <a href="MDVisionDefault.aspx#Patient/patTabReferrals" action="patTabReferrals" title="Referrals">Referrals</a>
                                                </li>
                                                <li runat="server" id="patMenuEncounter" visible="false">
                                                    <a href="MDVisionDefault.aspx#Patient/patTabEncounter" action="patTabEncounter" title="Encounter">Encounter</a>
                                                </li>
                                                <li runat="server" id="patMenuLetter" visible="false">
                                                    <a href="MDVisionDefault.aspx#Patient/patTabLetter" action="patTabLetter" title="Letter">Letter</a>
                                                </li>
                                                <li runat="server" id="patMenuCustomForm" visible="false">
                                                    <a href="MDVisionDefault.aspx#Patient/patTabCustomForm" action="patTabCustomForm" title="Custom Form">Custom Form</a>
                                                </li>
                                        ...
                                        <li class="nav-parent" id="mstrMenuSchedule" runat="server" visible="false">
                                           ...
                                           <%-- <ul class="nav nav-children">
                                                <li id="schMenuCalendar" class="nav-active" runat="server" visible="false">
                                                    <a href="MDVisionDefault.aspx#Schedule/schTabCalendar" title="Schedule Calendar">Calendar</a>
                                                </li>
        
                                                <li id="schMenuWaitList" runat="server">
                                                    <a href="MDVisionDefault.aspx#Schedule/schTabWaitList" title="Wait List">Wait List</a>
                                                </li>
                                            </ul>--%>
                                        </li>
                                        ...
                                        <li class="nav-parent" id="mstrMenuBilling" runat="server" visible="false">
                                            ...
                                            <ul class="nav nav-children">
                                                <li id="billMenuUnClaimedAppointment" runat="server" visible="false">
                                                    <a href="MDVisionDefault.aspx#Billing/billTabUnClaimedAppointment" title="Unclaimed Appointments">Unclaimed Appointments</a>
                                                </li>
                                                <li id="billMenuChargeSearch" runat="server" visible="false">
                                                    <a href="MDVisionDefault.aspx#Billing/billTabChargeSearch" title="Charges">Charges</a></li>
                                                <li id="billMenuOutOfOfficeVisits" runat="server" visible="false">
                                                    <a href="MDVisionDefault.aspx#Billing/billTabOutOfOfficeVisits" title="Out of Office Visits">Out of Office Visits</a>
                                                </li>
                                                <li id="billMenuChargeBatchSearch" runat="server" visible="false">
                                                    <a href="MDVisionDefault.aspx#Billing/billTabChargeBatchSearch" title="Charge Batch">Charge Batch</a>
                                                </li>
                                                <li id="billMenuClaimSubmission" runat="server" visible="false">
                                                    <a href="MDVisionDefault.aspx#Billing/billTabClaimSubmission" title="Claim Submission">Claim Submission</a>
                                                </li>
                                                <li id="billMenuPaymentPosting" runat="server" visible="false">
                                                    <a href="MDVisionDefault.aspx#Billing/billTabPaymentPosting" title="Payment Posting">Payment Posting</a>
                                                </li>
                                                <li id="billMenuCopayReceipt" runat="server" visible="false">
                                                    <a href="MDVisionDefault.aspx#Billing/billTabCopayReceipt" title="Copay Receipt Search">Copay Receipt</a>
                                                </li>
                                                <li id="billMenuPatientStatement" runat="server" visible="false">
                                                    <a href="MDVisionDefault.aspx#Billing/billTabPatientStatement" title="Patient Statement">Patient Statement</a>
                                                </li>
                                                <li id="billMenuPaymentBatchSearch" runat="server" visible="false">
                                                    <a href="MDVisionDefault.aspx#Billing/billTabPaymentBatchSearch" title="Payment Batch">Payment Batch</a>
                                                </li>
                                                <li id="billMenuEDIReport" runat="server" visible="false">
                                                    <a href="MDVisionDefault.aspx#Billing/billTabEDIReport" title="EDI Reports">EDI Reports</a>
                                                </li>
                                                <li id="billMenuERA" runat="server" visible="false">
                                                    <a href="MDVisionDefault.aspx#Billing/billTabERA" title="ERA">ERA</a>
                                                </li>
                                                <li class="nav-parent" id="billMenuFollowUp" runat="server" visible="false">
                                                    ...
                                                    <ul class="nav nav-children">
                                                        <li id="billMenuFollowUpPatientAR" runat="server" visible="false">
                                                            <a href="MDVisionDefault.aspx#Billing/billTabFollowUpPatientAR" title="Patient AR">Patient AR</a>
                                                        </li>
                                                        <li id="billMenuFollowUpInsuranceAR" runat="server" visible="false">
                                                            <a href="MDVisionDefault.aspx#Billing/billTabFollowUpInsuranceAR" title="Insurance AR">Insurance AR</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                       ...
                                       <li id="mstrMenuReports" runat="server" class="nav-parent" visible="false">
                                            <a class="nav-parent" runat="server" href="#Reports" onclick="SelectTab('mstrTabReports','true');">
                                          ...
                                          <li class="nav-parent" id="mstrMenuiTrack" runat="server" visible="false">
                                            <%--<a data-toggle="tab" title="iTrack" onclick="SelectTab('mstrTabiTrack','true');">
                                             ...
                                             <a href="#iTrack" data-toggle="tab" title="iTrack" >
                                                <i class="fa fa-book" aria-hidden="true"></i><span>iTrack</span> </a>
                                            <ul class="nav nav-children">
                                                   ...
                                                   <a>Meaningful Use (MU)</a>
                                                    <ul class="nav nav-children">
                                                        <%--<li id="iTrackMenuMuStage2" runat="server" visible="false">
                                                            <a href="javascript:SelectTab('iTrackTabDashboard','true');" title="MU Stage 2">MU Stage 2</a>
                                                        </li>--%>
                                                         <li id="iTrackMenuMUReport" runat="server" >
                                                            <a href="javascript:SelectTab('iTrackTabMUReport','true');" title="MU Stage 3">MU Stage 3</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li id="iTrackMenueCQMs" runat="server" >
                                                    <a href="javascript:SelectTab('iTrackTabeCQMs','true');" title="Clinical Quality Measure">eCQMs</a></li>
                                                 <li id="iTrackMenuMIPS"  class="nav-parent" runat="server" visible="false">
                                                   <a>MIPS</a>
                                                    <ul class="nav nav-children">
                                                        <li id="iTrackMenuMIPSummary" runat="server" >
                                                            <a href="javascript:SelectTab('iTrackTabMIPSummary','true');" title="MIPS Summary">MIPS Summary</a>
                                                        </li>
                                                         <li id="iTrackMenuQuality" runat="server" >
                                                            <a href="javascript:SelectTab('iTrackTabQuality','true');" title="Quality">Quality</a>
                                                        </li>
                                                        <li id="iTrackMenuPromotingInteroperability" runat="server" >
                                                            <a href="javascript:SelectTab('iTrackTabPromotingInteroperability','true');" title="Promoting Interoperability (Formerly ACI)">Promoting Interoperability (Formally ACI)</a>
                                                        </li>
                                                         <li id="iTrackMenuImprovementActivities" runat="server" >
                                                            <a href="javascript:SelectTab('iTrackTabImprovementActivities','true');" title="IA (Improvement Activities)">IA (Improvement Activities)</a>
                                                        </li>
                                                        <li id="iTrackMenuCost" runat="server" >
                                                            <a href="javascript:SelectTab('iTrackTabCost','true');" title="Cost">Cost</a>
                                                        </li>
                                                         <li id="iTrackMenuSubmission" runat="server" >
                                                            <a href="javascript:SelectTab('iTrackTabSubmission','true');" title="Submission">Submission</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                        ...
                                        <li class="nav-parent" id="mstrMenuAuditbleEvents" runat="server" visible="false">
                                            <a class="noContentAfter" href="MDVisionAuditableEvents.aspx#AuditbleEvents" title="Auditable Events">
                                                <i class="fa fa-calendar-check-o " aria-hidden="true"></i>
                                                <span>Auditable Events</span>
                                            </a>
                                            <ul class="nav nav-children">
                                                <li id="auditbleEventsMenuActivityLog" runat="server"><a runat="server" title="Activity Log" href="javascript:SelectTab('auditbleEventsTabActivityLog','true');" onclick="SelectTab('auditbleEventsTabActivityLog','true');" >Activity Log
                                                </a>
                                                </li>
                                            </ul>
                                        </li>
    ...
    <!--End Print Preview For PDF Creation-->
     ...
     <%: Scripts.Render("~/bundles/StartupReports") %>
