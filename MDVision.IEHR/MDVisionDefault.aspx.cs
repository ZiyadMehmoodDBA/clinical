            ...
            if (IsPostBack == false)
            {
                ...
                try
                {
                    if (MDVSession.Current.UserLoggedIn)
                    {
                        ...
                        if(MDVUtility.ToInt64(MDVSession.Current.AssignedResultsCount) > 0)
                        {
                            spnAssignedResults.InnerText = MDVSession.Current.AssignedResultsCount;
                        }
                        ...
                        JsFuncs.RunJS(Page, "SetGlobalAppData('IsProviderBulkSign','" + MDVSession.Current.IsBulkSign + "');");

                        //if (ConfigurationManager.AppSettings["VersionNo"] != null)
                        //  if (ConfigurationManager.AppSettings["VersionNo"].ToString() != "")
                        //JsFuncs.RunJS(Page, "SetGlobalAppData('PatchNo','" + ConfigurationManager.AppSettings["PatchNo"] + "');");
                        ...
                        JsFuncs.RunJS(Page, "SetGlobalAppData('IsSelectCompOnCopyNote','" + MDVSession.Current.IsSelectCompOnCopyNote + "');");
                        //PRD-31 by:MAHMAD
                        JsFuncs.RunJS(Page, "SetGlobalAppData('IsExpandFolderTree','" + MDVSession.Current.IsExpandFolderTree + "');");
                        //PRD-31 by:MAHMAD
                        JsFuncs.RunJS(Page, "SetGlobalAppData('IsPreviousNoteComplaints','" + MDVSession.Current.IsPreviousNoteComplaints + "');");
                        JsFuncs.RunJS(Page, "SetGlobalAppData('IsPreviousNoteROS','" + MDVSession.Current.IsPreviousNoteROS + "');");
                        JsFuncs.RunJS(Page, "SetGlobalAppData('IsPreviousNotePE','" + MDVSession.Current.IsPreviousNotePE + "');");
                        JsFuncs.RunJS(Page, "SetGlobalAppData('IsConfigureAlerts','" + MDVSession.Current.IsConfigureAlerts + "');");
                        JsFuncs.RunJS(Page, "SetGlobalAppData('IsPreviousNoteProblems','" + MDVSession.Current.IsPreviousNoteProblems + "');");
                        JsFuncs.RunJS(Page, "SetGlobalAppData('PBPatientCCMTimer','" + MDVSession.Current.PBPatientCCMTimer + "');");
                        JsFuncs.RunJS(Page, "SetGlobalAppData('IsPrevNoteTreatmentComents','" + MDVSession.Current.IsPrevNoteTreatmentComents + "');");
                        ...
                        JsFuncs.RunJS(Page, "SetGlobalAppData('DefaultTabMessages','" + MDVSession.Current.DefaultTabMessages + "');");
                        JsFuncs.RunJS(Page, "SetGlobalAppData('RecentMessagesTab','" + MDVSession.Current.RecentMessagesTab + "');");

                        JsFuncs.RunJS(Page, "SetGlobalAppData('isLandOnComponent','" + MDVSession.Current.isLandOnComponent + "');");
                        JsFuncs.RunJS(Page, "SetGlobalAppData('DefaultTabMedications','" + MDVSession.Current.DefaultTabMedications + "');");
                        JsFuncs.RunJS(Page, "SetGlobalAppData('IsNoteCompExpanded','" + MDVSession.Current.IsNoteCompExpanded + "');");
            ...
            if (MDVSession.Current.listCustomerInfo != null)
            {
                ...
                if (list.Count == 1)
                {
                    ...
                    if (string.IsNullOrEmpty(PreInt()))
                        Response.Redirect(MDVSession.Current.WebEntityURL + "MDVisionDefault.aspx");
                    //}
                    //else
                    //{
