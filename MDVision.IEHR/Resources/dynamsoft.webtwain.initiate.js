...
(function (lib, undefined) {
    var OP = Object.prototype, AP = Array.prototype, toString = OP.toString, win = window, nil = undefined, EMPTY_STR = "", FALSE = !1, TRUE = !0, _console = FALSE, class2TypeMap = {}, mix, each, navInfo, isNil, types, mixIsFunctions;
    ...
    lib.each = each = function (object, fn, context) {
        if (object) {
            var key, val, keys, i = 0, length = object.length, isObj = isNil(length) || lib.isFunction(object);
    ...
    lib.getRandom = function () {
        var a = new Date().getTime() % 10000, b = [], tmp;
        for (var i = 0; i < 5; i++) {
    ...
    mix(lib, {
        ...
        getOffset: function (evt, _parent, target) {
            ...
            var el = target || evt.target, x = 0, y = 0, parentLeft = 0, parentTop = 0, scrollTop, scrollLeft, bFixed = false;
    ...
    var logger = lib.getLogger(), SEP = "&", EQ = "=", HEX_BASE = 16, htmlEntities = {
        "&amp;": "&",
        "&gt;": ">",
        "&lt;": "<",
        "&#x60;": "`",
    ...
    lib.mix(lib, {
        ...
        param: function (o, sep, eq, serializeArray) {
            ...
            var buf = [], key, i, v, len, val, encode = lib.urlEncode;
            for (key in o) {
                val = o[key];
                key = encode(key);
        ...
        unparam: function (str, sep, eq) {
            ...
            sep = sep || SEP;
            eq = eq || EQ;
            var ret = {}, eqIndex, decode = lib.urlDecode, pairs = str.split(sep), key, val, i = 0, len = pairs.length;
            for (; i < len; ++i) {
    ...
    var Path = lib.Path = {
        ...
        relative: function (from, to) {
            ...
            var fromParts = lib.filter(from.split("/"), function (p) {
                return !!p
            }), path = [], sameIndex, sameIndex2, toParts = lib.filter(to.split("/"), function (p) {
                return !!p
...
(function (s) {
    var ao, g = RegExp, ac, Z, f, k, t, aj, W, S, r, u, o, p, am = !0, d, K, b, Q, ak = "dws_" + 1 * new Date(), al = window.document, I = 0, w = 0, ag = ar(), ah = ar(), E = ar(), x = function (i, e) {
        if (i === e) {
            r = true
        }
        return 0
    }, G = [], T = G.pop, Y = G.push, ai = G.push, C = G.slice, F = function (av, au) {
        var at = 0
          , e = av.length;
        for (; at < e; at++) {
            if (av[at] === au) {
        ...
        return -1
    }, ae = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", O = "[\\x20\\t\\r\\n\\f]", z = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", ab = ["\\[", O, "*(", z, ")(?:", O, "*([*^$|!~]?=)", O, "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(", z, "))|)", O, "*\\]"].join(""), B = new g(O + "+", "g"), af = new g(["^", O, "+|((?:^|[^\\\\])(?:\\\\.)*)", O, "+$"].join(""), "g"), m = new g(["^", O, "*,", O, "*"].join("")), V = new g(["^", O, "*([>+~]|", O, ")", O, "*"].join("")), D = new g("=" + O + "*([^\\]'\"]*?)" + O + "*\\]", "g"), h = new g("^" + z + "$"), U = {
        ID: new g("^#(" + z + ")"),
        CLASS: new g("^\\.(" + z + ")"),
        TAG: new g("^(" + z + "|[*])"),
        ATTR: new g("^" + ab),
        needsContext: new g(["^", O, "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(", O, "*((?:-\\d)?\\d*)", O, "*\\)|)(?=[^-]|$)"].join(""), "i")
    }, J = /^[^{]+\{\s*\[native \w/, aa = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, P = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, l = function (i, e) {
        if (e) {
            if (i === "\0") {
                return "\uFFFD"
            }
    ...
    function ad(az, at, aC, aF) {
        var ax, aD, aw, e, aE, av, aA, au = at && at.ownerDocument, aB = at ? at.nodeType : 9;
        aC = aC || [];
    ...
    u = ad.setDocument = function (at) {
        ...
        : function (av, az) {
            var aA, ay = [], ax = 0, aw = az.getElementsByTagName(av);
            if (av === "*") {
                while ((aA = aw[ax++])) {
                    if (aA.nodeType === 1) {
                        ay.push(aA)
        ...
        : function (aw, av) {
            ...
            var aC, az = 0, aB = aw.parentNode, ay = av.parentNode, ax = [aw], aA = [av];
            if (!aB || !ay) {
    ...
    k = ad.tokenize = function (av, aA) {
        var i, aw, ay = [], az, ax, at, e, au = ah[av + " "];
        if (au) {
    ...
    function L(e, at, au, av, ay) {
        var aw, aB = [], ax = 0, az = e.length, aA = at != null;
        for (; ax < az; ax++) {
            if ((aw = e[ax])) {
                if (!au || au(aw, av, ay)) {
                    aB.push(aw);
    ...
    function ap(at, i, av, au, aw, e) {
        ...
        return an(function (aH, aE, az, aG) {
            var aJ, aF, aB, aA = [], aI = [], ay = aE.length, ax = aH || H(i || "*", az.nodeType ? [az] : az, []), aC = at && (aH || !i) ? L(ax, aA, at, az, aG) : ax, aD = av ? aw || (aH ? at : ay || au) ? [] : aE : aC;
            if (av) {
                av(aC, aD, az, aG)
            }
            if (au) {
    ...
    function N(ay) {
        var at, aw, au, ax = ay.length, aB = Z.relative[ay[0].type], aC = aB || Z.relative[" "], av = aB ? 1 : 0, az = M(function (i) {
            return i === at
        }, aC, true), aA = M(function (i) {
            return F(at, i) > -1
        }, aC, true), e = [function (aF, aE, aD) {
    ...
    function n(au, at) {
        var e = at.length > 0
          ...
          , i = function (aF, az, aE, aD, aI) {
              var aA, aB, aG, aK = 0, aC = "0", aw = aF && [], aL = [], aJ = W, ay = aF || av && Z.find.TAG("*", aI), ax = (I += aJ == null ? 1 : Math.random() || 0.1), aH = ay.length;
              if (aI) {
                  W = az === o || az || aI
              }
    ...
    aj = ad.select = function (e, ax, aw, at) {
        var av, ay = typeof e === "function" && e, au = !at && k((e = ay.selector || e));
        aw = aw || [];
...
(function (l) {
    ...
    var M = l.support
      , Q = l.all;
    var d, R, U, I, t, m, L = document.createElement("div"), X = document.createElement("div");
    if (!X.style) {
        return
    }
    ...
    var C, Y = ["Webkit", "O", "Moz", "ms"], H = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|dialog|figcaption|figure|footer|header|hgroup|main|mark|meter|nav|output|picture|progress|section|summary|template|time|video";
    ...
    function o(ah, ae) {
        var af, ai, ag = 0, aj = typeof ah.getElementsByTagName !== "undefined" ? ah.getElementsByTagName(ae || "*") : typeof ah.querySelectorAll !== "undefined" ? ah.querySelectorAll(ae || "*") : undefined;
        if (!aj) {
            for (aj = [],
            af = ah.childNodes || ah; (ai = af[ag]) != null; ag++) {
    ...
    function j(af, ah) {
        var am, aj, al, ao, aq, ap, ag, ak = af.length, ai = V(ah), ae = [], an = 0;
        for (; an < ak; an++) {
            aj = af[an];
            if (aj || aj === 0) {
                if (l.type(aj) === "object") {
    ...
    function n(af, ae, ai, an) {
        var ao, ag = 1, ak = 20, am = an ? function () {
            return an.cur()
        }
        : function () {
            return x.css(af, ae, "")
        }
        , aj = am(), al = ai && ai[3] || (x.cssNumber[ae] ? "" : "px"), ah = (x.cssNumber[ae] || al !== "px" && +aj) && P(x.css(af, ae));
        if (ah && ah[3] !== al) {
            al = al || ah[3];
            ai = ai || [];
            ah = +aj || 1;
    ...
    l.style = x.style = function (ag, af, al, ah) {
        ...
        var aj, ak, am, ai = x.camelCase(af), ae = ag.style;
    ...
    var a = " "
      ...
      , aa = function (ai, ak) {
          var ah = ai.className, ae, af = ak.length, aj, ag;
          if (ah) {
              ae = ab(ah);
              aj = ah;
              ag = 0;
      ...
      , D = function (ai, ak) {
          var ag = ai.className, ah, ae = ak.length, af, aj;
          if (ag && ae) {
              ah = ab(ag);
              af = 0;
              for (; af < ae; af++) {
...
(function (a) {
    var g = a.lib, d = a.navInfo, f = window.document, b, e;
    e = function (i) {
        var h = i;
        if (h == "mousewheel") {
    ...
    b = {
        ...
        getWheelDelta: function (h) {
            h = h || window.event;
            var k, j = h.wheelDelta, i = h.detail;
            if (j) {
                k = j / 120
            }
            if (i) {
...
(function (s, e, o) {
    var l = window, h = /^(?:about|app|app\-storage|.+\-extension|file|widget)$/, F = 200, b = 204, g = 300, t = 304, n = 404, f = 1223, u = 500, C = -1022, E = "The local service (Dynamsoft Service) is disconnected.", x = "open error: ", v = "send error: ", i = new s.Uri(location.href), B = i && h.test(i.getScheme()), D = false, j = function () {
        try {
        ...
        return o
    }, r = (!B && l.XMLHttpRequest) ? ("withCredentials" in (j() || [])) : false, A = l.ActiveXObject ? function (H) {
    ...
    k = {
        ...
        _ioReady: function (L, J) {
            ...
            var Q = I ? "onSuccess" : "onError", M, P = [R.responseData, J, R], H = K.context;
            M = K[Q];
            if (s.isFunction(M)) {
                M.apply(H, P)
            }
        ...
        handleResponseData: function () {
            var J = this, H, I = J.dataType, L = J.nativeXhr;
        ...
        sendInternal: function () {
            var S = this, W = S, O, I, J, V, T, U, K, P, N, M;
            I = S.method;
            J = S.url;
            V = S.dataType;
            K = S.mimeType;
...
(function (i) {
    ...
    a.prototype = {
        ...
        mapReverseSymbol: function (o) {
            var n = this, q = n.symbolMap, p, r = n.reverseSymbolMap;
            if (!r && q) {
        ...
        lex: function () {
            var x = this, v = x.input, q, u, n, s, y, w = x.getCurrentRules();
            x.match = x.text = "";
            if (!v) {
    ...
    d.productions = [[13, [14]], [14, [15], function () {
        return this.$1
    }
    ], [15, [2], function () {
    ...
    d.parse = function h(x) {
        var z = this, n = z.lexer, s, E, D, H = z.table, A = H.gotos, r = H.action, q = z.productions, t = [null], u = [0];
        n.resetInput(x);
        while (1) {
            s = u[u.length - 1];
            if (!E) {
            ...
            switch (D[e.TYPE_INDEX]) {
                case e.SHIFT_TYPE:
                    ...
                    break;
                case e.REDUCE_TYPE:
                    var I = q[D[e.PRODUCTION_INDEX]], y = I.symbol || I[0], p = I.action || I[2], B = I.rhs || I[1], G = B.length, F = 0, J, w = t[t.length - G];
                    z.$$ = w;
                    J = undefined;
                    for (; F < G; F++) {
    ...
    var i = window
      ...
      , d = function (v) {
          for (var w = 0; w < o.styleSheets.length; ++w) {
              var B = o.styleSheets[w], y = k, t = k, A, C;
              try {
                  y = B.cssRules;
        ...
        if (x) {
            ...
            if (j) {
                ...
                y._resizeFn = function () {
                    ...
                    setTimeout(function () {
                        var F, H, E = y.style, G = q ? o.body : o.documentElement;
                        if (w) {
    ...
    h.mix(d.prototype, {
        ...
        _convertByteSize: function (j) {
            ...
            do {
                j = j / 1024;
                k++
            } while (j > 99 && k < 4); return Math.max(j, 0.1).toFixed(1) + ["KB", "MB", "GB", "TB"][k]
        },
        _init: function () {
            var j = this;
            var m = {
...
(function (n, j, b) {
    var h = !0, s = !1, x = navigator.userAgent.toLowerCase(), w = document.location.protocol, c = location.hostname, e = location.pathname, q = b.bSSL, t = b.bMac, A = b.bLinux, v = b.bWin, k = b.isX64, l = b.bSafari, m = b.bFirefox, o = b.bEdge, r = b.bChrome, u = b.bIE, z = b.bFileSystem, y = parseFloat(b.strBrowserVersion), g = s, f = s, p = s, d = 0, a, i;
    if (r || m) {
        if (y >= 27) {
            g = h
        } else {
...
(function (b) {
    var a = {
        ...
        drawImageWithHermite: function (M, l, p, n, o, f) {
            var c = M.width, h = M.height, A = Math.min(o, l.width), q = Math.min(f, l.height), N = M.getContext("2d").getImageData(0, 0, c, h), L = l.getContext("2d").getImageData(p, n, A, q), J = N.data, I = L.data, m = c / A, E = h / q, z = Math.ceil(m / 2), C = Math.ceil(E / 2), G, F;
            for (F = 0; F < q; F++) {
                for (G = 0; G < A; G++) {
...
(function (a) {
    a.DOM = {
        getOffset: function (k, f) {
            var c = k.target, j = 0, i = 0, g = 0, h = 0, b, e, d = false;
...
Dynamsoft.WebTwainEnv.ShowDialog = function (f, j, k, a, g) {
    var b = Dynamsoft.Lib, e = b.install, n;
    if (!b.get("J_waiting")) {
...
(function (c) {
    ...
    c.attachMethod = function (h) {
        ...
        h.ChangeImageSize = function (m, q, j, k) {
            var l = parseInt(m), n, p;
            n = i.getSWebTwain().ChangeImageSize(l, q, j, k),
            p = (n == 1);
            return p
        }
        ;
        ...
        h.SaveAllAsMultiPageTIFF = function (j, n, l) {
            var m = f.replaceLocalFilename(j), k;
        ...
        h._ChangeWidth = function (k) {
            var j = document.getElementById(h._strDWTInnerContainerID), m;
            if (c.isString(k)) {
                if (k.length > 0) {
        ...
        h.LoadImageEx = function (k, n, q, m) {
            var p = f.replaceLocalFilename(k), j = n, l;
        ...
        h.AcquireImage = function (s, r, p) {
            var j = i.getSWebTwain(), q, m = null, n = null, l = null;
        ...
        ;
        h.first = function () {
            var j = i.HowManyImagesInBuffer, k;
            if (j > 0) {
...
(function (b) {
    ...
    a.prototype._createControl = function () {
        var e;
        var h = this, g = h._strWidth, d = h._strHeight, f;
        if (b.isString(g)) {
            if (g.indexOf("%") > 0) {
                g = "100%"
            } else {
    ...
    b.ie.closeAll = function () {
        var d = b.detect.arySTwains, e, g, f;
...
(function (b) {
    ...
    var c = document, f = navigator, e, d = {
    ...
    e._createControl = function () {
        var l = this, i, k = l._strWidth, h = l._strHeight, j;
        if (b.isString(k)) {
            if (k.indexOf("%") > 0) {
                k = "100%"
            } else {
    ...
    b.plugin.closeAll = function () {
        var g = b.detect.arySTwains, h, k, j;
...
(function (c) {
    ...
    var g = 1, h, f = !1, b = !0, e = Dynamsoft.WebTwainEnv, a = {
        ActiveX: 0,
        Plugin: 1,
        HTML5: 2,
        WinMacLinux: 3,
    ...
    h = c.html5.Funs = {
        ...
        getRandom: function () {
            var k = new Date().getTime() % 10000, j = [], m;
            for (var l = 0; l < 5; l++) {
        ...
        initImageUI: function (n, q) {
            var k, j, l = n._width, p = n._height, m = false;
        ...
        changeImageUISize: function (n, m, p) {
            var k, l, t = -1, w = -1, j = m, v = p, s = false, u, q;
            k = c.one("#" + n._strDWTControlContainerID);
        ...
        bindUIViewEvents: function (l, j) {
            ...
            j.onMouseClick = function (q) {
                ...
                if (Dynamsoft.Lib.isFunction(m.__OnMouseClick)) {
                    m.__OnMouseClick(p)
                    //if (DWObject.HowManyImagesInBuffer != DWObject.SelectedImagesCount) {
                        resetSelectAllImgCheck();
                    //}
                }
            }
            ;
        ...
        loadHttpBlob: function (p, w, n, q, x, j, v) {
            var l = "loadHttpBlob", y, s, u = false;
            y = function (E, B, D) {
                var A, C;
        ...
        httpPostUpload: function (p, j, n, s, v, k, q, r, x) {
            ...
            var m = p.MaxUploadImageSize, u = n.size, t = n.type, l;
            if (u > m && m != -1) {
        ...
        checkProductKey: function (G, z, E) {
            ...
            var F = 0, j = 0, D = [], l = f, q = f, t = f, H = f, v = f, C, w = G.__bTrial;
...
(function (a) {
    ...
    b._OnReady = function (h) {
        ...
        d.onmessage = function (m) {
            ...
            var v;
            if (l.cmdId) {
                var t = g.curCommand.length, p, j = -1;
                for (p = t - 1; p >= 0; p--) {
    ...
    ;
    b.__unload = function () {
        var g = this, d, e = g._strDWTControlContainerID, f = document.getElementById(e);
        if (g._UIManager) {
            g._UIManager.clear()
        }
        if (g.bReady) {
...
(function (a) {
    ...
    b.__LoadImageFromBytes = function (v, l, r, n, u, h, j, w) {
        var q = this, k = "LoadImageFromBytes", z = l || 3, s = v.size || v.length, g, e = d.isServerInvalid(q), y = true;
...
(function (a) {
    ...
    b.ChangeImageSize = function (p, f, l, n) {
        var h = this, j = parseInt(p), m = 1 * f, k = 1 * l, e, g;
    ...
    ;
    b.CustomViewMode = function (j, f, w, h) {
        var k = this, g, e;
        g = Math.floor(j);
        e = Math.floor(f);
        k._UIManager.CustomViewMode(g, e, w, h);
        return true
    }
    ;
    b.MoveImage = function (j, h) {
        var k = this, g = parseInt(j), e = parseInt(h), f;
...
(function (a) {
    ...
    b.SaveSelectedImagesAsMultiPagePDF = function (h, l, j) {
        var m = this, k = e.replaceLocalFilename(h), g;
    ...
    b.HTTPDownloadDirectly = function (t, g, m, s, k) {
        var p = this, j = e.combineUrl(p, t, g), h, q, n;
        if (j === false) {
    ...
    b.HTTPUploadThroughPostDirectly = function (v, q, g, n, u, l) {
        var s = this, h = d.GetHttpHeadersAndClear(s), j = "HTTPUploadThroughPostDirectly", k = e.combineUrl(s, v, g), p = true, r, t;
        if (v === "") {
    ...
    b.HTTPUpload = function (h, l, p, F, j, z) {
        var x = this, q = parseInt(p), B = parseInt(F), D, u = "HTTPUpload", G, n = h, A = true, H = false, w = x._moduleSize, E = x._segementUploadThreshold, y, C, r, t;
    ...
    var d = {
        ...
        UploadBase64: function (q, k, s, x, l, f, n, r, t, p, v) {
            var h = x.getLength(), j = "HttpUpload", u, g, w = 0;
            u = h - n;
            if (u > 0) {
                if (u >= r) {
                    u -= r;
    ...
    b.__innnerHTTPUploadBinaryFull = function (h, g, u, n, j, f) {
        var t = this, q = d.GetHttpHeadersAndClear(t), r = "HTTPUpload", y, l = h, w = true, z = false, s = 0, v, x, p;
    ...
    b.__innnerHTTPUploadBase64Full = function (g, u, y, w, p, x) {
        var r = this, h = d.GetHttpHeadersAndClear(r), j = "HTTPUpload", l, k = g, q = true, t = false, s = 0, n, v, f;
    ...
    b.ConvertToBase64 = function (q, n, j, f) {
        var k = this, g = parseInt(n), h = "SaveSelectedImagesToBase64Binary", l;
...
(function (a) {
    ...
    b._OnPostAllTransfers = function (f) {
        var k = this, e, h, g = k._UIManager.GetCurrentImageIndex(), j = k._UIManager.count();
        if (f.length >= 2) {
            k._errorCode = f[1];
            k._errorString = f[2]
        }
    ...
    b._OnPercentDone = function (p) {
        ...
        if ((Dynamsoft.Lib.cancelFrome == 0 && j.__IfShowProgressBar == true) || (Dynamsoft.Lib.cancelFrome != 0 && j.__IfShowCancelDialogWhenImageTransfer == true)) {
            var n = Dynamsoft.Lib.get("progressBar"), h = Dynamsoft.Lib.get("status"), e = Dynamsoft.Lib.get("finalMessage"), k = 0, l;
...
(function (b) {
    ...
    e.LoadImageFromBase64Binary = function (l, r, s, k) {
        var p = this, j = c, h = "LoadImageFromBase64Binary", n = r, q;
    ...
    e.HTTPDownloadThroughPost = function (t, h, j, s, l) {
        var n = this, k = g.combineUrl(n, t, h), q, p;
        if (k === c) {
    ...
    e.GetImageURL = function (p, j, h, t) {
        var n = this, q = p, r = parseInt(j), m = parseInt(h), s, k, l;
        if (t) {
            s = "";
            k = "dwt://"
        } else {
...
(function (b) {
    ...
    c.prototype.__init = function (f) {
        ...
        Dynamsoft.Lib.addEventListener(h.canvas, "mousedown", function (j) {
            selectedImagesArr = DWObject._UIManager._UIView.aryCurrentSelectedImageIndicesInBuffer;
            h.onMouseDown(j);
            retainSelectedImages();
            b.stopPropagation(j);
        });
    ...
    c.prototype.onMouseDown = function (t) {
        var m = this, p = t.target, j = d, h, r, k, s, l, n, q;
    ...
    c.prototype.__drawBoxBorder = function (s, f, l, r, m, q, v) {
        var u = this, k, j, w, n, C, h, A, z, t, g, D;
        z = Math.floor(f);
        t = Math.floor(l);
        if (r <= 0 || m <= 0) {
            return
    ...
    c.prototype.__drawUpTriangle = function (A, j, t) {
        var q = this, u, s, m, g, f, r, v = 9, n = 4, B, z, k, l;
        B = Math.floor(j);
        z = Math.floor(t);
        k = Math.floor(v);
        l = Math.floor(n);
    ...
    c.prototype.__drawLeftTriangle = function (A, j, t) {
        var q = this, u, s, m, g, f, r, v = 4, n = 7, B, z, k, l;
        B = Math.floor(j);
        z = Math.floor(t);
        k = Math.floor(v);
        l = Math.floor(n);
    ...
    c.prototype.__drawRightTriangle = function (z, j, s) {
        var q = this, t, r, m, g, f, u = 4, n = 7, A, v, k, l;
        A = Math.floor(j);
        v = Math.floor(s);
        k = Math.floor(u);
        l = Math.floor(n);
...
(function (b) {
    ...
    e.prototype.SetSelectedArea = function (h, r, s, g, k) {
        var p = this, u = p.canvas.getContext("2d"), w, t, f, n, j, l, q = p.drawWidth, v = p.drawHeight, m = false;
...
(function (c) {
    ...
    a.prototype.__init = function (f) {
        ...
        h.divTag.className = "imgTag imgTag_Selected";
        ...
        if (!h.imageAreaSelector) {
            ...
            h.imageAreaSelector.onMouseMove = function (q) {
                ...
                if ((h.iMouseShape == EnumDWT_MouseShape.Hand) && k) {
                    var t, s, r, p, j = h.__isShowScrollV(), v = h.__isShowScrollH();
            ...
            h.imageAreaSelector.onImageAreaSelected = function (q) {
                var m = q.left, p = q.top, r = q.right, l = q.bottom, j = q.fromScroll, n, k;
    ...
    a.prototype.ImageMoveLeft = function () {
        var h = this, f = h.__isShowScrollH(), g;
        if (f && h.scrollH) {
    ...
    a.prototype.ImageMoveUp = function () {
        var h = this, f = h.__isShowScrollV(), g;
        if (f && h.scrollV) {
    ...
    a.prototype.ImageMoveHome = function () {
        var k = this, g = k.__isShowScrollV(), h = k.__isShowScrollH(), j, f;
        if (g && k.scrollV) {
    ...
    a.prototype.__getScrollInfoWithNewZoom = function (E) {
        var A = this, G = {
            x: 0,
            y: 0
        }, h, g, v, u, n, l, p = false, r, D, q, x, y, j, f, s, z, H;
        r = A.fZoomValue;
        if (r <= 0 || !A.objImage) {
            return G
        }
        ...
        bOldShowScrollV = A.__isShowScrollV(y),
        bOldShowScrollH = A.__isShowScrollH(j);
        z = A.__isShowScrollV(),
        H = A.__isShowScrollH();
        f = A.canvasWidth;
        s = A.canvasHeight;
    ...
    a.prototype.__recaculateDrawArea = function () {
        var l = this, g = false, k = false, f, h = false, j = false;
    ...
    a.prototype.__resetScroll = function () {
        var h = this, k, g, f = h.__isShowScrollV(), l = h.__isShowScrollH(), q, j, p, m, n;
        if (h.canvas) {
...
(function (a) {
    ...
    Funs2 = {
        ...
        print: function (l) {
            ...
            var v, q = ["alwaysRaised=yes,z-look=yes,top=0,left=0,toolbar=no,menubar=no,location=no,status=no,width=", f, ",height=", c].join(""), b = '<html><body id="D_img">' + r + "</body></html>";
...
(function (a) {
    ...
    f.prototype.__OnMouseClick = function (l) {
        ...
        var t = p.aryCurrentSelectedImageIndicesInBuffer.indexOf(q)
          , k = 1 /*//Actual condition was=>k=l.e.ctrlKey//this was seted as k=1 for overright ctrl key for selection unselection*/
          , r = l.e.shiftKey
          , s = l.e.metaKey;
        if (t == -1) {
        ...
        if (q.bVerticalMode == true) {
            ...
            if (q.iCurrentRow != t && (q.iCurrentRow <= q.iOldFirstVisibleRow || ((q.iCurrentRow - q.iOldFirstVisibleRow) >= q.imagesPerRow))) {
                ...
                if (q.iOldFirstVisibleRow != m) {
                    ...
                    selectedImagesArr = q.aryCurrentSelectedImageIndicesInBuffer;
    ...
    ;
    f.prototype.CustomViewMode = function (t, l, w, h) {
        var p = this;
        p.imageViewHeight = h;
        p.imageViewWidth = w;
        var m = p.imagesPerColumn;
    ...
    f.prototype.SetSelectedImageIndex = function (p, n) {
        ...
        var l = -1, k = r.aryCurrentSelectedImageIndicesInBuffer.length, q;
        for (var m = 0; m < k; m++) {
    ...
    if (b) {
        if (c.imageUrl && c.imageUrl != "") {
            ...
            k.onerror = function (m) {
                var n = d.GetBindIndex(), p = l.View, h;
...
(function (c) {
    ...
    var f = "eng"
      ...
      , e = {
          ...
          getToolBar: function (t, h, w) {
              ...
              var l = document.createElement("ul"), v, q, p;
              var m = b.btninfo.length, u = false, k;
    ...
    function a(k, h) {
        var m = this, j = h || {}, g, l = '<div class="D_ImageUIEditor noPaddingnoMarginInside thinborder"></div>';
        m._UIManager = k;
    ...
    a.prototype.previous_btn = function () {
        var j = this, g, h = c.one(j.toolbar.self).one(".Class_D_DWT_Editor_Buttons_previous");
        if (h && h[0]) {
            g = h[0].src;
            if (g.indexOf("grey") != -1) {
                return
                ...
                j.previous()
                $("#" + Document_Scan.params["PanelID"]).find('#chkSelectAllScnImgs').prop("checked", false);
            }
        }
    }
    ;
    a.prototype.next_btn = function () {
        var j = this, g, h = c.one(j.toolbar.self).one(".Class_D_DWT_Editor_Buttons_next");
        if (h && h[0]) {
            g = h[0].src;
            if (g.indexOf("grey") != -1) {
                return
    ...
    a.prototype.Crop_btn = function () {
        var j = this, g, h = c.one(j.toolbar.self).one(".Class_D_DWT_Editor_Buttons_crop");
        if (h && h[0]) {
            g = h[0].src;
            if (g.indexOf("grey") != -1) {
                return
    ...
    a.prototype.__EnableMouseShapButtons = function (p) {
        var j = this, n = c.one(j.toolbar.self), q, m, k;
        if (n) {
...
(function (a) {
    ...
    ;
    e.prototype.CustomViewMode = function (g, f, w, h) {
        return this.getView().CustomViewMode(g, f, w, h)
    }
    ;
    e.prototype.GetImageWidth = function (j) {
        var n = this, k = j * 1, g, m, l, h, f;
        m = n.getView();
    ...
    e.prototype.SetBackgroundColor = function (h) {
        var l = this, j = h, f, k, g = l.getView();
...
(function (a) {
    ...
    a.getWS = function (h, d, c) {
        var j = this, f, g = a.getWSUrl(h, d, c), e = a.product.wsProtocol;
    ...
    b.RemoveAllAuthorizations = function () {
        var e = a.LS.item("DWT_port"), g = a.LS.item("DWT_ssl"), c = "http://", d = a.product.ip, f;
        if (g == "true") {
            c = "https://"
        }
...
(function (a, F) {
    var I = dynamsoft.navInfo
      ...
      , v = {
          ...
          versionInfo: function (Y, X) {
              var W = 0
                , U = function (ae, ab) {
                    var aa = [v._getPreUrl(Y[v.curPortIndex]), "f/VersionInfo?ts=", a.now()].join(""), Z, ad;
    ...
    a.DynamicWebTwain = N;
    var H = window, n = H.document, l, o, Q = "This browser is currently not supported.", B = "Duplicate ID detected for creating Dynamic Web TWAIN objects, please check and modify.", J = a.each, f = "dwt", j = 0, C = 1, u = 2, w = 3, A = !0, N = !1, d = function (T) {
    ...
    a.detect.isDWTVersionLatest = function (U) {
        ...
        var W = a.detect.getVersionArray(X), T, Y;
    ...
    var p = function () {
      ...
      , r = function (X, U, T) {
          var ab = N, Y = N, V = a.detect, W = X.dwtPort, Z = dynamsoft.navInfo, aa;
          if (V.dcpStatus == u) {
