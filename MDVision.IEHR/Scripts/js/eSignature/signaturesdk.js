Signaturesdk = {
    ...
    JSONreq: { map: {}, counter: 0, getJSON: function (e, t, n) { var a = e + (e.indexOf("?") + 1 ? "&" : "?"), c = document.getElementsByTagName("head")[0], s = document.createElement("script"), m = [], r = "", i = "json-" + this.counter; this.counter++, t.script_name = i, t._rand = Math.random(), this.map[i] = n, t.callback = "Signaturesdk.JSONreq.success"; for (r in t) m.push(r + "=" + encodeURIComponent(t[r])); a += m.join("&"), s.type = "text/javascript", s.src = a, s.id = i, c.appendChild(s) }, success: function (e) { var t = e.script_name; delete e.script_name, this.map[t](e); var n = document.getElementsByTagName("head")[0], a = document.getElementById(t); n.removeChild(a), delete this.map.script_name } },
    WacomGSS_SignatureSDK: function (_onDetectRunning, service_port) {
        this.running = false;
        this.session = null;
        ...
        function onGetPort(server_data) {
            if (0 == server_data.status) {
                ...
                Signaturesdk.JSONreq.getJSON(server_url + "wacom.js", data, onGetSession)
            }
            else {
        ...
        function checkService() {
            var data = { "GetPort": 1 };
            Signaturesdk.JSONreq.getJSON(server_url + service_port + "/wacom.js", data, onGetPort);
        }
        checkService();
        ...
        this.Hash = function (_onHash) {
            ...
            Signaturesdk.JSONreq.getJSON(server_url + "wacom.js", data, callback);
            ...
            this.SetEventHandler = function (eventHandler) {
                ...
                function callback(server_data) {
                    ...
                    if (0 == parseInt(server_data.status)) {
                        Signaturesdk.JSONreq.getJSON(server_url + "wacom.js", update_data, callback);
                    }
