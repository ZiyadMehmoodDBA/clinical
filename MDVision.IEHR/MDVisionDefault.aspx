<%@ Page Title="Home Page" Async="true" Language="C#" AutoEventWireup="true" CodeBehind="MDVisionDefault.aspx.cs" Inherits="MDVision.IEHR._Default" %>
...
<head id="PageHead" runat="server">
    ...
    <asp:PlaceHolder ID="PlaceHolder2" runat="server">
        ...
        <%:Scripts.Render("~/bundles/DashboardFiles") %>
        <%:Scripts.Render("~/bundles/DashboardFilesSecondLayer") %>
        
         <%:Scripts.Render("~/bundles/DashboardFilesThirdLayer") %>
        <%:Scripts.Render("~/bundles/DashboardFilesForthLayer") %>
         <%:Scripts.Render("~/bundles/DashboardFilesFifthLayer") %>
        ...
        <script src="Scripts/js/pdf/build/pdf.min.js"></script>
        <script src="Scripts/js/pdf/build/pdf.min.worker.js"></script>
...
<body onload="initSession();">
        ...
        <section class="body">
                    ...
                    <section class="controls-xs">
                            ...
                            <div class="tabs">
                                <ul class="nav nav-tabs">
                                    <li id="mstrTabDashBoard" visible="false" runat="server">
                                        <a href="#" data-toggle="tooltip" title="DashBoard" onclick="SelectTab('mstrTabDashBoard','false');">
                                            <span>DashBoard</span>
                                            <i class="fa fa-dashboard"></i>
                                        </a>
                                    </li>
                                    <li id="mstrTabPatient" runat="server" visible="false">
                                        <a href="#Patient" data-toggle="tooltip" title="Patient" onclick="SelectTab('mstrTabPatient','false');">
                                            <span>Patient</span>
                                            <i class="fa fa-user"></i>
                                        </a>
                                    </li>
                                    <li id="mstrTabSchedule" runat="server" visible="false">
                                        <a href="#Schedule" data-toggle="tooltip" title="Scheduler" onclick="SelectTab('mstrTabSchedule','false');">
                                            <span>Scheduler</span>
                                            <i class="fa fa-calendar"></i>
                                        </a>
                                    </li>
                                    <li id="mstrTabClinical" runat="server" visible="false">
                                        <a href="#Clinical" data-toggle="tooltip" title="Clinical" onclick="SelectTab('mstrTabClinical','false');">
                                            <span>Clinical</span>
                                            <i class="fa fa-user"></i>
                                        </a>
                                    </li>
                                    <li id="mstrTabBilling" runat="server" visible="false">
                                        <a href="MDVisionBilling.aspx#Billing" data-toggle="tooltip" title="Billing" onclick="CheckDemographicDetailOnRedirect('MDVisionBilling.aspx#Billing', event);">
                                            <span>Billing</span>
                                            <i class="fa fa-book"></i>
                                        </a>
                                    </li>
                                    <li id="mstrTabBatch" runat="server" visible="false">
                                        <a href="#Batch" data-toggle="tooltip" title="Batch" onclick="SelectTab('mstrTabBatch','false');">
                                            <span>Batch</span>
                                            <i class="fa fa-cubes"></i>
                                        </a>
                                    </li>
                                    <li id="mstrTabReports" runat="server" visible="false">
                                        <a href="MDVisionReports.aspx#Reports" data-toggle="tooltip" title="Reports" onclick="CheckDemographicDetailOnRedirect('MDVisionReports.aspx#Reports', event);">
                                            <span>Reports</span>
                                    ...
                                    <li id="mstrTabAuditbleEvents" runat="server" visible="false">
                                        <a href="MDVisionAuditableEvents.aspx#AuditableEvents" data-toggle="tooltip" title="Auditable Events" onclick="CheckDemographicDetailOnRedirect('MDVisionAuditableEvents.aspx#AuditbleEvents', event);">
                                    ...
                                    <li id="mstrTabAdmin" runat="server" visible="false">
                                        <a href="MDVisionAdmin.aspx#Admin" title="" onclick="CheckDemographicDetailOnRedirect('MDVisionAdmin.aspx#Admin', event);">
                                            <span>Admin</span>
                        ...
                        <div class="pull-right hidden-xs">
                            <ul class="notifications">
                                <%-- Author: Ahmad Raza
                                   Date: March 8, 2016
                                   Reason: To show CDS Alert  Quick Link on Dashboard --%>

                                <li runat="server" id="AssignedResults">
                                    <a href="#" class="notification-icon" runat="server" id="btnAssignedResults" onclick="DashBoard.OpenAssignedResults();" name="AssignedResults" style="display: inline-block;" data-toggle="tooltip" data-placement="bottom" title="Assigned Results">
                                        <i class="fa fa-flask"></i>
                                        <span id="spnAssignedResults" runat="server" class="badge"></span>
                                    </a>
                                </li>

                                <li runat="server" id="CDSAlert" hidden="hidden">
                                    <a href="#" class="notification-icon" runat="server" style="display: inline-block;" id="A1" data-toggle="tooltip" data-placement="bottom" title="CDS Alert" onclick="ClinicalCDSDetail.openCDSAlert();">
                                        <i class="fa fa-exclamation-triangle"></i>
                                        <span id="spnCDSAlert" runat="server" class="badge"></span>
                                        <input id="hfCDSIDs" name="CDSIDs" type="hidden" value="">
                                        <input id="hfTriggerLocation" name="TriggerLocation" type="hidden" value="FaceSheet">
                                        <input id="hfTriggerPatientId" name="TriggerPatientId" type="hidden" value="">
                                    </a>
                                </li>

                                <li runat="server" id="PendingDocuments">
                                    <a href="#" class="notification-icon" runat="server" style="display: inline-block;" id="A2" data-toggle="tooltip" data-placement="bottom" title="Pending Documents Alert" onclick="DashBoard.OpenPendingDocuments();">
                                        <i class="fa fa-files-o"></i>
                                        <span id="spnPendingDocumentsCount" runat="server" class="badge"></span>
                                    </a>
                                </li>
                                <li runat="server" id="ImmunizationAlert">
                                    <a href="#" class="notification-icon" runat="server" style="display: inline-block;" id="A3" data-toggle="tooltip" data-placement="bottom" title="Immunization Alert" onclick="Immunization_AlertConfiguration.OpenAlertsPage();">
                                        <i class="fa fa-bell"></i>
                                        <span id="spnImmunizationAlertCount" runat="server" class="badge"></span>
                                    </a>
                                </li>
                                <%-- end Change BY Ahmad Raza
                                    Date: March 8, 2016 --%>
                                ...
                                <li runat="server" id="PrescriptionsRefill">
                                    <a href="#" class="notification-icon" runat="server" style="display: inline-block;" id="btnPrescriptionsRefill" data-toggle="tooltip" data-placement="bottom" title="Prescriptions Refill" onclick="Clinical_Prescriptions.openDrFirstRefillPrescription();">
                                        <i class="fa fa-refresh"></i>
                                        <span id="spnPrescriptionsRefillCount" runat="server" class="badge"></span>
                                    </a>
                                </li>
                                <li runat="server" id="PendingPrescriptions">
                                    <a href="#" class="notification-icon" runat="server" style="display: inline-block;" id="btnPendingPrescriptions" data-toggle="tooltip" data-placement="bottom" title="Pending Prescriptions" onclick="Clinical_Prescriptions.openDrFirstPendingPrescription();">
                                        <i class="fa fa-exclamation-circle"></i>
                                        <span id="spnPendingPrescriptionsCount" runat="server" class="badge"></span>
                                    </a>
                                </li>
                                <%-- end Change BY Azhar
                                    Date: Januray 18, 2016 --%>
                                <li runat="server" id="Notes">
                                    <a href="#" class="notification-icon" runat="server" style="display: inline-block;" id="btnNotes" data-toggle="tooltip" data-placement="bottom" title="Provider Note" onclick="Scheduling_Search.OpenProviderNotes();">
                                        <i class="fa fa-file"></i>
                                        <span id="spnNotesCount" runat="server" class="badge"></span>
                                    </a>
                                </li>

                                <li runat="server" id="Appointments">
                                    <a href="#" class="notification-icon" runat="server" style="display: inline-block;" id="btnAppointments" data-toggle="tooltip" data-placement="bottom" title="Appointments" onclick="Scheduling_Search.OpenPatientAppointments();">
                                        <i class="fa fa-calendar"></i>
                                        <span id="spnAppCount" runat="server" class="badge"></span>
                                    </a>
                                </li>
                                <li runat="server" id="Alerts">
                                    <a href="#" class="notification-icon" runat="server" style="display: none;" id="btnPatientAlerts" data-toggle="tooltip" data-placement="bottom" title="Patient Alerts" onclick="Patient_Demographic.OpenPatientAlerts();">
                                        <i class="fa fa-bell"></i>
                                        <span id="spnAlertCount" class="badge">3</span>
                                    </a>
                                </li>
                                <li runat="server" id="Faxes">
                                    <a href="#" class="notification-icon" style="display: inline-block;" runat="server" id="btnFaxes" data-toggle="tooltip" data-placement="bottom" title="Fax" onclick="OpenFaxes();">
                                        <i class="fa fa-fax"></i>
                                ...
                                <li runat="server" id="Messages">
                                    <a href="#" class="notification-icon" style="display: none;" runat="server" id="btnPatientMessages" data-toggle="tooltip" data-placement="bottom" title="Messages" onclick="OpenUserMessages();">
                                        <i class="fa fa-envelope"></i>
                                        <span id="spnMessageCount" runat="server" class="badge"></span>
                                    </a>
                                </li>
                                <li runat="server" id="Tasks">
                                    <a href="#" class="notification-icon" style="display: none;" runat="server" id="btnUserTasks" data-toggle="tooltip" data-placement="bottom" title="Tasks" onclick="OpenUserTasks();">
                                        <i class="fa fa-tasks"></i>
                                        <span id="spnUserTasksCount" runat="server" class="badge"></span>
                                    </a>
                                </li>
                                <li runat="server" id="AddPatient">
                                    <a href="#" class="notification-icon" runat="server" id="btnAddPatient" onclick="Patient_Demographic.OpenDemographicQuick();" data-toggle="tooltip" data-placement="bottom" title="Quick Add Patient">
                                        <i class="fa fa-user-plus"></i>
                                    </a>
                                </li>
                                <li runat="server" id="PatientSearch">
                                    <a href="#" class="notification-icon" runat="server" id="btnPatientSearch" onclick="Patient_Demographic.OpenPatientSearch();" name="btnPatientSearch" data-toggle="tooltip" data-placement="bottom" title="Search&nbsp;Patient">
            ...
            <div class="inner-wrapper">
                <div id="pnlTab2">
                    <aside id="sidebar-left" class="sidebar-left">
                        ...
                        <div class="sidebar-header">
                            ...
                            <div class="sidebar-toggle hidden-xs" data-toggle-class="sidebar-left-collapsed" data-target="html" data-fire-event="sidebar-left-toggle" onclick="DocumentCustomViewMode()"><i class="fa fa-bars" aria-label="Toggle sidebar"></i></div>
                        </div>
                        <div class="nano">
                                ...
                                <nav id="menu" class="nav-main" role="navigation">
                                    <ul class="nav nav-main" id="mainUL">
                                        ...
                                        <li id="mstrMenuDashBoard" runat="server" class="nav-parent" visible="false">
                                            <a class="nav-parent" runat="server" href="" onclick="SelectTab('mstrTabDashBoard','true');">
                                        ...
                                        <li id="mstrMenuPatient" class="nav-parent" runat="server" visible="false">
                                            <a data-toggle="tab" href="#Patient" title="Patient" onclick="SelectTab('mstrTabPatient','true');">
                                                <i class="fa fa-user" aria-hidden="true"></i>
                                                <span>Patient</span>
                                            </a>
                                            <ul class="nav nav-children">
                                                <li runat="server" id="patMenuDemographic" class="nav-active" visible="false">
                                                    <a href="javascript:SelectTab('patTabDemographic','true');" action="patTabDemographic" title="Demographics">Demographics</a>
                                                </li>
                                                <li runat="server" id="patMenuInsurance" visible="false">
                                                    <a href="javascript:SelectTab('patTabInsurance','true');" action="patTabInsurance" title="Insurance">Insurance</a>
                                                </li>
                                                <li runat="server" id="patMenuDocuments" visible="false">
                                                    <a href="javascript:SelectTab('patTabDocuments','true');" action="patTabDocuments" title="Documents">Documents</a>
                                                </li>
                                                <li runat="server" id="patMenuMessages" visible="false">
                                                    <a href="javascript:SelectTab('patTabMessages','true');" action="patTabMessages" title="Tasks">Tasks</a>
                                                </li>
                                                <li runat="server" id="patMenuUserMessages" visible="false">
                                                    <a href="javascript:SelectTab('patTabUserMessages','true');" action="patTabUserMessages" title="Messages">Messages</a>
                                                </li>
                                                <li runat="server" id="patMenuCaseManagement" visible="false">
                                                    <a href="javascript:SelectTab('patTabCaseManagement','true');" action="patTabCaseManagement" title="Case Management">Case Management</a>
                                                </li>
                                                <li runat="server" id="patMenuActivityLog" visible="false">
                                                    <a href="javascript:SelectTab('patTabActivityLog','true');" action="patTabActivityLog" title="Audit Log">Audit Log</a>
                                                </li>
                                                <li runat="server" id="patMenuReferrals" visible="false">
                                                    <a href="javascript:SelectTab('patTabReferrals','true');" action="patTabReferrals" title="Referrals">Referrals</a>
                                                </li>
                                                <li runat="server" id="patMenuEncounter" visible="false">
                                                    <a href="javascript:SelectTab('patTabEncounter','true');" action="patTabEncounter" title="Encounter">Encounter</a>
                                                </li>
                                                <li runat="server" id="patMenuLetter" visible="false">
                                                    <a href="javascript:SelectTab('patTabLetter','true');" action="patTabLetter" title="Letter">Letter</a>
                                                </li>
                                                <li runat="server" id="patMenuCustomForm" visible="false">
                                                    <a href="javascript:SelectTab('patTabCustomForm','true');" action="patTabCustomForm" title="Custom Form">Custom Form</a>
                                                </li>
                                                <li runat="server" id="patMenuAppointments" visible="false">
                                                    <a href="javascript:SelectTab('patTabAppointments','true');" action="patTabAppointments" title="Appointments">Appointments</a>
                                                </li>

                                            </ul>
                                        </li>
                                        <li class="nav-parent" id="mstrMenuSchedule" runat="server" visible="false">
                                            <a href="#Schedule" data-toggle="tab" title="Scheduler" onclick="SelectTab('mstrTabSchedule','true');">
                                                <i class="fa fa-calendar" aria-hidden="true"></i>
                                                <span>Scheduler</span>
                                            </a>
                                            <ul class="nav nav-children">
                                                <li id="schMenuCalendar" class="nav-active" runat="server" visible="false">
                                                    <a href="javascript:SelectTab('schTabCalendar','true');" title="Schedule Calendar">Calendar</a>
                                                </li>
                                                <%--<li id="schMenuSearch" runat="server" visible="false">
                                                    <a href="javascript:SelectTab('schTabSearch','true');" title="Schedule Search">Search</a>
                                                </li>
                                                <li id="schMenuMultipleView" runat="server" visible="false">
                                                    <a href="javascript:SelectTab('schTabMultipleView','true');" title="Multiple View">Multiple View</a>
                                                </li>--%>
                                                <li id="schMenuWaitList" runat="server">
                                                    <a href="javascript:SelectTab('schTabWaitList','true');" title="Wait List">Wait List</a>
                                                </li>
                                            </ul>
                                        </li>

                                        <li class="nav-parent" id="mstrMenuClinical" runat="server" visible="false">
                                            <a class="noContentAfter" href="#Clinical" data-toggle="tab" title="Clinical" onclick="SelectTab('mstrTabClinical','false');">
                                            ...
                                            <ul class="nav nav-children">
                                                ...
                                                <li id="billMenuERA" runat="server" visible="false">
                                                 ...
                                                 <li id="billMenuEOBManualPosting" runat="server" visible="false">
                                                    <a href="MDVisionBilling.aspx#Billing/billTabEOBManualPosting" title="EOB Posting">EOB Posting</a>
                                                </li>
                                        ...
                                        <li class="nav-parent" id="mstrMenuBatch" runat="server" visible="false">
                                            ...
                                            <ul class="nav nav-children">
                                                <li id="batchMenuDocuments" runat="server" visible="false">
                                                    <a href="javascript:SelectTab('batchTabDocuments','true');" title="Documents">Documents</a>
                                                </li>
                                                <li id="batchMenuMessages" runat="server" visible="false">
                                                    <a href="javascript:SelectTab('batchTabMessages','true');" title="Tasks">Tasks</a>
                                                </li>
                                                <li id="batchMenuPatientEligibility" runat="server" visible="false">
                                                    <a href="javascript:SelectTab('batchTabPatientEligibility','true');" title="Patient Eligibility">Patient Eligibility</a>
                                                </li>
                                                <li id="batchMenuEncounter" runat="server" visible="false">
                                                    <a href="javascript:SelectTab('batchTabEncounter','true');" title="Encounter">Encounter</a>
                                                </li>
                                                <li id="batchMenuFax" runat="server" visible="false">
                                                    <a href="javascript:SelectTab('batchTabFax','true');" title="Fax">Fax</a>
                                                </li>
                                                <li id="batchMenuEmail" runat="server" visible="false">
                                                    <a href="javascript:SelectTab('batchTabEmail','true');" title="Email">Email</a>
                                                </li>

                                               <%-- <li id="batchMenuClinicalQualityMeasure" runat="server" visible="false">
                                                    <a href="javascript:SelectTab('batchTabClinicalQualityMeasure','true');" title="Clinical Quality Measure">Clinical Quality Measure</a>
                                                </li>--%>
                                                <li id="batchMenuIzendaReports" runat="server" visible="false">
                                                    <a href="javascript:SelectTab('batchTabIzendaReports','true');" title="Izenda Report Test">Izenda Report Test</a>
                                                </li>
                                                <li id="batchMenuPatientList" runat="server" visible="false">
                                                    <a href="javascript:SelectTab('batchTabPatientList','true');" title="Patient List">Patient List</a>
                                                </li>
                                                <li id="batchMenuImportCCDA" runat="server" visible="false">
                                                    <a href="javascript:SelectTab('batchTabImportCCDA','true');" title="Import CCDA">Import CCDA</a>
                                                </li>
                                                <li id="batchMenuExportCCDA" runat="server" visible="false">
                                                    <a href="javascript:SelectTab('batchTabExportCCDA','true');" title="Export CCDA">Export CCDA</a>
                                                </li>
                                                <li id="batchMenuImportHL7LabResults" runat="server" visible="false">
                                                    <a href="javascript:SelectTab('batchTabImportHL7LabResults','true');" title="Import HL7 Lab Results">Import HL7 Lab Results</a>
                                                </li>
                                                <li id="batchMenuImportHL7ImmunizationBatch" runat="server" visible="false">
                                                    <a href="javascript:SelectTab('batchTabImportHL7ImmunizationBatch','true');" title="Import Immunization HL7">Import Immunization HL7</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li id="mstrMenuReports" runat="server" class="nav-parent" visible="false">
                                            <a class="nav-parent" runat="server" href="MDVisionReports.aspx#Reports">
                                                        ...
                                                        <li class="nav-parent" id="adminMenuFavorites" runat="server" visible="false">
                                                            ...
                                                            <ul class="nav nav-children">
                                                                ...
                                                                <li id="adminMenuFavoritesProcedure" runat="server" visible="false">
                                                                    <a href="MDVisionAdmin.aspx#Admin/adminTabFavoritesProcedure" title="Favorites Procedure">Procedure</a>
                                                                </li>
                                                         ...
                                                         <li id="AdminMenuMacro" runat="server" visible="true">
                                                            <a href="MDVisionAdmin.aspx#Admin/adminTabMacro" title="Macros">Macros</a>
                                                        </li>
                                    ...
                                    <ul class="nav nav-main clinicalMenu" id="ClinicalUL">
                                        ...
                                        <li class='nav-parent' id='clinicalMenuScreening' style='display:block;'>
                                            <a data-toggle="tab" title="Screening" href="#mstrTabScreening" onclick="ClinicalMenuClick(event,function(){ClinicalMenuSettings.TopButtons('clinicalMenuScreening')';ClinicalMenuSettings.selectClinicalMenu('clinicalMenuScreening');},1,this,'VBP_MissingDataAlert','li')">
                                                <i class="fa fa-flask" aria-hidden="true"></i><span>Screenings</span>
                                            </a>
                                            <ul id="sortableScreening" class="nav nav-children">
                                                <li class="ui-state-default" id="clinicalMenu_Screening_Depression">
                                                    <a href="#mstrTabScreening" onclick="javascript:SelectTab('clinicalTabDepression',true)"; title="Depression">Depression</a>
                                                
                                                </li>
                                                <li class="ui-state-default" id="clinicalMenu_Screening_Tabacoo">
                                                    <a href="#mstrTabScreening" onclick="javascript:SelectTab('clinicalTabTabacoo',true)"; title="Tabacoo">Tabacoo</a>
                ...
                <section role="main" class="content-body">
                    <div id="pnlTab3" class="hidden-xs">
                        <div class="tab-content full-tab-row">
                            ...
                            <%--<div class="tab-pane" id="mstrDivAuditbleEvents">
                             ...
                             <div class="tab-pane" id="mstrDivScreening">
                            </div>
                    ...
                    <div id="containerOrthoPedicComplaints" onclick="CloseOrthoScreen(this,event)" tabindex="-1" role="dialog" aria-hidden="true"></div>
    ...
    <div id="signNotePrint" style="display: none">
        <div id="PatientInfo" class="form-group">
    ...
    <%: Scripts.Render("~/bundles/StartupDashboard") %>
</body>
</html>
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $(window).on('beforeunload', function () {
            ...
            objData["IsComponentOnly"] = false;
            objData["ComponentName"] = "";
            objData["commandType"] = "remove_user_note_access";
            var inputData = JSON.stringify(objData);
            MDVisionService.APIService(inputData, "CLINICALNOTES", "ClinicalNotes");
            //$.ajax({
            //    type: "POST",
            //    url: "api/CLINICALNOTES/ClinicalNotes",
            //    data: { data: inputData },
            //    dataType: "json",
            //    async: false,
            //}).promise();
