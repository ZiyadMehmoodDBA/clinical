...
namespace MDVision.Business.BLL
{
    public class BLLAdminEDI
    {
        ...
        /// <returns></returns>
        public BLObject<DSEDI> LoadEDISubmitInsurance(long EDISubmitId, string CHouseId, string SubmitInsName, string PayorId, string IsActive, int PageNumber = 1, int RowsPerPage = 1000)
        {
            try
            {
                DSEDI ds = new DSEDI();
                ds = new DALEDISubmitInsurance().LoadEDISubmitInsurance(EDISubmitId, CHouseId, SubmitInsName, PayorId,IsActive, PageNumber, RowsPerPage);
                return new BLObject<DSEDI>(ds);
            }
            catch (Exception ex)
            {
                MDVLogger.BLLErrorLog("BLLAdminEDI::LoadEDISubmitInsurance", ex);
                return new BLObject<DSEDI>(null, ex.Message);
            }
        }
        ...
        /// <returns></returns>
        public BLObject<DSEDI> UpdateEDISubmitInsurance(DSEDI ds)
        {
            try
            {
                ds = new DALEDISubmitInsurance().UpdateEDISubmitInsurance(ds);
                return new BLObject<DSEDI>(ds);
            }
            catch (Exception ex)
            {
        ...
        public BLObject<string> DeleteEDISubmitInsurance(string SpecialtyIds)
        {
            try
            {
                SpecialtyIds = new DALEDISubmitInsurance().DeleteEDISubmitInsurance(SpecialtyIds);
        ...
        /// <param name="ds">The ds.</param>
        /// <returns></returns>
        public BLObject<DSEDI> InsertEDISubmitInsurance(DSEDI ds)
        {
            try
            {
                ds = new DALEDISubmitInsurance().InsertEDISubmitInsurance(ds);
                return new BLObject<DSEDI>(ds);
            }
            catch (Exception ex)
            {
        ...
        /// <param name="PayorId">The payor identifier.</param>
        /// <returns></returns>
        public BLObject<DSEDI> LoadEDIClaimStatusInsurance(long EDIStatusId, string CHouseId, string EDIStatusInsName, string PayorId, string IsActive, int PageNumber = 1, int RowsPerPage = 1000)
        {
            try
            {
                DSEDI ds = new DSEDI();
        ...
        /// <param name="ds">The ds.</param>
        /// <returns></returns>
        public BLObject<DSEDI> UpdateEDIClaimStatusInsurance(DSEDI ds)
        {
            try
            {
        ...
        /// <param name="ds">The ds.</param>
        /// <returns></returns>
        public BLObject<DSEDI> InsertEDIClaimStatusInsurance(DSEDI ds)
        {
            try
            {
        ...
        /// <param name="PayorId">The payor identifier.</param>
        /// <returns></returns>
        public BLObject<DSEDI> LoadEDIEligibilityInsurance(long EDIEligibilityId, string CHouseId, string EDIStatusInsName, string PayorId, string IsActive, int PageNumber = 1, int RowsPerPage = 1000)
        {
            try
            {
                DSEDI ds = new DSEDI();
        ...
        /// <param name="ds">The ds.</param>
        /// <returns></returns>
        public BLObject<DSEDI> UpdateEDIEligibilityInsurance(DSEDI ds)
        {
            try
            {
        ...
        /// <param name="ds">The ds.</param>
        /// <returns></returns>
        public BLObject<DSEDI> InsertEDIEligibilityInsurance(DSEDI ds)
        {
            try
            {
        ...
        /// <returns></returns>
        public BLObject<DSEDI> LoadClearingHouse(long ClearingHouseId, string ShortName, string Type, string EntityId, string IsActive, int PageNumber = 1, int RowsPerPage = 1000)
        {
            try
            {
                DSEDI ds = new DSEDI();
        ...
        /// <param name="ds">The ds.</param>
        /// <returns></returns>
        public BLObject<DSEDI> UpdateClearingHouse(DSEDI ds)
        {
            try
            {
        ...
        /// <param name="ds">The ds.</param>
        /// <returns></returns>
        public BLObject<DSEDI> InsertClearingHouse(DSEDI ds)
        {
            try
            {
        ...
        /// <returns></returns>
        public BLObject<DSEDI> LoadEDITaxIDSetup(long EDITaxIDSetupId, string TaxID, string Clearinghouse, string EntityId, string IsActive, int PageNumber = 1, int RowsPerPage = 1000)
        {
            try
            {
                DSEDI ds = new DSEDI();
        ...
        /// <param name="ds">The ds.</param>
        /// <returns></returns>
        public BLObject<DSEDI> UpdateEDITaxIDSetup(DSEDI ds)
        {
            try
            {
        ...
        /// <param name="ds">The ds.</param>
        /// <returns></returns>
        public BLObject<DSEDI> InsertEDITaxIDSetup(DSEDI ds)
        {
            try
            {
        ...
        /// <returns></returns>
        public BLObject<DSEDI> LoadSubmitterSetup(long SubmitterSetupId, string OrganizationLastName, string ShortName, string EntityId, string IsActive, int PageNumber = 1, int RowsPerPage = 1000)
        {
            try
            {
                DSEDI ds = new DSEDI();
        ...
        /// <param name="ds">The ds.</param>
        /// <returns></returns>
        public BLObject<DSEDI> InsertSubmitterSetup(DSEDI ds)
        {
            try
            {
        ...
        /// <param name="ds">The ds.</param>
        /// <returns></returns>
        public BLObject<DSEDI> UpdateSubmitterSetup(DSEDI ds)
        {
            try
            {
        ...
        /// <param name="ShortName">The short name.</param>
        /// <returns></returns>
        public BLObject<DSEDI> LoadReceiverSetup(long EDIReceiverSetupId, string SubmitterID, string ShortName, string ClearingHouseId, string EntityId, string IsActive, int PageNumber = 1, int RowsPerPage = 1000)
        {
            try
            {
                DSEDI ds = new DSEDI();
        ...
        /// <param name="ds">The ds.</param>
        /// <returns></returns>
        public BLObject<DSEDI> InsertReceiverSetup(DSEDI ds)
        {
            try
            {
        ...
        /// <param name="ds">The ds.</param>
        /// <returns></returns>
        public BLObject<DSEDI> UpdateReceiverSetup(DSEDI ds)
        {
            try
            {
        ...
        /// <param name="ReceiverSetupId">The receiver setup identifier.</param>
        /// <returns></returns>
        public BLObject<DSEDI> LoadReceiverSetupX12(long ReceiverSetupId)
        {
            try
            {
                DSEDI ds = new DSEDI();
        ...
        /// <param name="ds">The ds.</param>
        /// <returns></returns>
        public BLObject<DSEDI> InsertReceiverSetupX12(DSEDI ds)
        {
            try
            {
        ...
        /// <param name="ds">The ds.</param>
        /// <returns></returns>
        public BLObject<DSEDI> UpdateReceiverSetupX12(DSEDI ds)
        {
            try
            {
        ...
        /// <returns></returns>
        public BLObject<DSEDI> LoadEDIServiceHandle(long eDIServiceHandleId, string entityId, string clearingHouseId, string Case, string mode, string time, string isActive, int PageNumber = 1, int RowsPerPage = 15)
        {
            try
            {
                DSEDI ds = new DSEDI();
                ds = new DALEDIServiceHandle().LoadEDIServiceHandle(eDIServiceHandleId, entityId, clearingHouseId, Case, mode, time, isActive, PageNumber, RowsPerPage);
                return new BLObject<DSEDI>(ds);
            }
            catch (Exception ex)
            {
                MDVLogger.BLLErrorLog("BLLAdminEDI::LoadEDIServiceHandle", ex);
                return new BLObject<DSEDI>(null, ex.Message);
            }
        }
        ...
        /// <param name="ds"></param>
        /// <returns></returns>
        public BLObject<DSEDI> UpdateEDIServiceHandle(DSEDI ds)
        {
            try
            {
                ds = new DALEDIServiceHandle().UpdateEDIServiceHandle(ds);
                return new BLObject<DSEDI>(ds);
            }
            catch (Exception ex)
            {
                MDVLogger.BLLErrorLog("BLLAdminEDI::UpdateEDIServiceHandle", ex);
                return new BLObject<DSEDI>(null, ex.Message);
            }
        }
        ...
        /// </summary>
        /// <param name="EDIServiceHandleIds"></param>
        /// <returns></returns>
        public BLObject<string> DeleteEDIServiceHandle(string EDIServiceHandleIds)
        {
            try
            {
                EDIServiceHandleIds = new DALEDIServiceHandle().DeleteEDIServiceHandle(EDIServiceHandleIds);
                return new BLObject<string>(EDIServiceHandleIds);
            }
            catch (Exception ex)
            {
                MDVLogger.BLLErrorLog("BLLAdminEDI::DeleteEDIServiceHandle", ex);
                return new BLObject<string>("", ex.Message);
            }
        }
        ...
        /// <param name="ds"></param>
        /// <returns></returns>
        public BLObject<DSEDI> InsertEDIServiceHandle(DSEDI ds)
        {
            try
            {
                ds = new DALEDIServiceHandle().InsertEDIServiceHandle(ds);
                return new BLObject<DSEDI>(ds);
            }
            catch (Exception ex)
            {
                MDVLogger.BLLErrorLog("BLLAdminEDI::InsertEDIServiceHandle", ex);
                return new BLObject<DSEDI>(null, ex.Message);
            }
        }
        ...
        /// </summary>
        /// <returns></returns>
        public BLObject<DSEDILookup> LookupEDISubmitInsurance()
        {
            try
            {
                DSEDILookup ds = new DSEDILookup();
                ds = new DALEDISubmitInsurance().LookupEDISubmitInsurance();
                return new BLObject<DSEDILookup>(ds);
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public BLObject<DSEDILookup> LookupEDIEligibilityInsurance()
        {
            try
            {
                DSEDILookup ds = new DSEDILookup();
        ...
        /// </summary>
        /// <returns></returns>
        public BLObject<DSEDILookup> LookupClearingHouse()
        {
            try
            {
                DSEDILookup ds = new DSEDILookup();
        ...
        /// </summary>
        /// <returns></returns>
        public BLObject<DSEDILookup> LookupClearingHouseType()
        {
            try
            {
                DSEDILookup ds = new DSEDILookup();
        ...
        /// </summary>
        /// <returns></returns>
        public BLObject<DSEDILookup> LookupSubmitterSetup()
        {
            try
            {
                DSEDILookup ds = new DSEDILookup();
        ...
        /// </summary>
        /// <returns></returns>
        public BLObject<DSEDILookup> LookupEDIReceiverSetup()
        {
            try
            {
                DSEDILookup ds = new DSEDILookup();
