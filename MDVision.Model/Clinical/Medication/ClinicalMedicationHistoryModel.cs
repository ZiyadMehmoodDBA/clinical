...
namespace MDVision.Model.Clinical.Medication
{
    ...
    public class ClinicalMedicationHistoryModel : IBaseModel
    {

        public string MedicationHistoryID { get; set; }
        ...
        public void Map(IDataReader reader, List<string> incommingColumnList)
        {
            ...
            MedicationHistoryID = ModelUtility.ToStr(ModelUtility.MapValue(reader, "MedicationHistoryID", incommingColumnList));
