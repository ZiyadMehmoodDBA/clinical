...
namespace MDVision.IEHR.EMR.Model.OrdersAndResults.LabResult
{
    ...
    {
        public ChildResultDetailModel()
        {
            childResultAttribueModel = new List<ChildResultAttribueModel>();
        }
        public string LabOrderResultDetailId { get; set; }
        public string LabOrderResultId { get; set; }
        public string ObservationDate { get; set; }
        public string OrganismCode { get; set; }
        public string OrganismCodeDescription { get; set; }
        ...
        public List<ChildResultDetailModel> ChildRows { get; set; }
        public List<ChildResultAttribueModel> childResultAttribueModel { get; set; }
        ...
        public string TestAntimicrobial { get; set; }

    }
   public class ChildResultAttribueModel
    {
